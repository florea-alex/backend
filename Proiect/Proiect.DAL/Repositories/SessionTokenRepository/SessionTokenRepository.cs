...
{
    public class SessionTokenRepository1 : GenericRepository<SessionToken>, ISessionTokenRepository
    {
        public SessionTokenRepository1(AppDbContext context) : base(context) { }
